...
CREATE TABLE chairs (
    id UUID NOT NULL,                   -- 椅子ID
    owner_id UUID NOT NULL,             -- オーナーID
...
CREATE TABLE rides (
    id UUID NOT NULL,                   -- ライドID
    user_id UUID NOT NULL,              -- ユーザーID
    chair_id UUID,                      -- 割り当てられた椅子ID
...
CREATE TABLE coupons (
    user_id UUID NOT NULL,              -- 所有しているユーザーのID
